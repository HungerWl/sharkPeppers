...
.fv-default-layout-sub-menu.el-menu--horizontal > .el-sub-menu .el-sub-menu__title:hover{
  background-color: var(--wl-sub-menu-hover-bg-color);
}
</style>
...
.fv-default-layout-sub-menu{
  /* color:initial; */
  /* --el-menu-text-color:var(--wl-sub-menu-text-color); */
  --el-menu-hover-bg-color:var(--wl-sub-menu-hover-bg-color);
  --el-menu-horizontal-height:calc(var(--wl-header-height) - 1px);
  --el-menu-item-font-size:var(--wl-sub-menu-item-font-size);
  background:transparent;
}

.el-menu--vertical{
  --el-menu-item-height:var(--wl-sub-menu-item-height);
  --el-menu-sub-item-height:var(--wl-sub-menu-item-height);
  border-right: none;

}
:deep(.el-menu--inline){
  background: var(--wl-sub-menu-inline-bg);
}
.fv-default-layout-sub-menu :deep(.is-active){
  background: var(--wl-sub-menu-active-bg);
  color: var(--wl-sub-menu-active-color);
}
.el-menu--vertical:not(.el-menu--collapse) {
  width: var(--wl-sub-menu-width);
}
