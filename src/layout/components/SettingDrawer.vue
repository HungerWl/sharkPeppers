      ...
      <el-scrollbar class=" pr-4">
        ...
        <div class="setting-item">
          ...
          <el-input-number
            ...
            @change="methods.updateSizeCssValue($event, '--wl-header-height')"
          />
        </div>
        ...
        <div class="setting-item">
          ...
          <el-input-number
            ...
            @change="methods.updateSizeCssValue($event, '--wl-sub-menu-width')"
          />
        </div>
        <el-divider :size="state.size">
        ...
        <div class="setting-item">
          ...
          <el-input-number
            ...
            controls-position="right"
            :disabled="!appStore.appConfig.isTabs"
            @change="methods.updateSizeCssValue($event, '--wl-tabs-height')"
          />
        </div>
        <el-divider :size="state.size">
        ...
        <div class="setting-item">
          ...
          <el-input-number
            ...
            @change="methods.updateSizeCssValue($event, '--wl-footer-heigth')"
          />
        </div>
