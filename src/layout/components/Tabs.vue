...
.fv-tabs-operation {
  ...
  height: calc(var(--wl-tabs-height) - 1px);
  width: auto;
  display: flex;
...
.fv-tabs-operation .el-dropdown-link:hover {
  background-color: var(--wl-tools-hover-bg-color);
}
...
.fv-tabs .el-tabs__nav-next:hover,
.fv-tabs .el-tabs__nav-prev:hover {
  background-color: var(--wl-tools-hover-bg-color);
  color: var(--el-color-primary);
}

.fv-tabs .el-tabs__nav-next,
.fv-tabs .el-tabs__nav-prev {
  height: 100%;
  align-items: center;
  display: flex;
  justify-content: center;
...
.fv-tabs .el-tabs {
  --el-tabs-header-height: var(--wl-tabs-height);
}
